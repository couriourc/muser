...
Muser is an idea collection,You can note your idea at time,and it will push u to finish it.
...
```bash
npx create-next-app precedent --example "https://github.com/couriourc/muser"
```
